...
export function __wbg_get_processor_selected_stack_storage_for_js(a: number): number;
export function __wbg_set_processor_selected_stack_storage_for_js(a: number, b: number): void;
export function processor_get_result(a: number, b: number): void;
export function processor_get_stack_storage(a: number, b: number): void;
export function processor_get_queue_storage(a: number, b: number): void;
...
export function processor_set_selected_stack_num(a: number, b: number): void;
