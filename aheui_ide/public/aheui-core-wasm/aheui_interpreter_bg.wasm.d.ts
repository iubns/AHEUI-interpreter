...
export function __wbg_get_processor_selected_storage_for_js(a: number): number;
export function __wbg_set_processor_selected_storage_for_js(a: number, b: number): void;
...
export function processor_set_selected_storage_num(a: number, b: number): void;
